    ...
    <>
          ...
          <ModalContent>
            <>
              {!updatePassword && !updateDisplayName && !updateSuccess && (
                <>
                  <UpdateButton onClick={() => setUpdatePassword(true)}>
                    UPDATE PASSWORD
                  </UpdateButton>
                  <UpdateButton onClick={() => setUpdateDisplayName(true)}>
                    UPDATE DISPLAY NAME
                  </UpdateButton>
                </>
              )}
              {updatePassword && (
                <>
                  ...
                  <UpdateButton
                    onClick={() => updateProfile("password", password)}
                  >
                    UPDATE PASSWORD
                  </UpdateButton>
                </>
              ...
              {updateSuccess && (
                <>
                  ...
                  <SuccessSubtext>
                    Note: You will need to refresh the page to see these
                    changes.
                  </SuccessSubtext>
                </>
              )}
              <CancelButton onClick={() => closeUpdateModal(false)}>
      ...
      <Background>
        ...
        <ProfileWrapper>
          ...
          <ProfileText isLink={true} onClick={() => setShowUpdateModal(true)}>
            Update Profile
          </ProfileText>
        </ProfileWrapper>
        <HamburgerIcon
        ...
        {showHamburgerMenu && (
          <HamburgerMenu>
            <HamburgerItem onClick={() => setShowUpdateModal(true)}>
              UPDATE PROFILE
            </HamburgerItem>
